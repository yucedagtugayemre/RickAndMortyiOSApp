        ...
        RMService.shared.execute(
            ...
            expecting: RMGetAllEpisodesResponse.self) { [weak self] result in
                ...
                case .success(let responseModel):
                    ...
                    let originalCount = storngSelf.episodes.count
                    ...
                    storngSelf.episodes.append(contentsOf: moreResults)
                    
                    

                    DispatchQueue.main.async {
                        storngSelf.delegate?.didLoadMoreEpisodes(with: indexPathsToAdd)
                       
                        storngSelf.isLoadingMoreEpisodes = false
                    }
